  ...
  <div id="app" class="page" v-cloak>
    <div class="master" v-if="$route.meta.hasMaster === true">
      <div class="page-sidebar">
        ...
        <ul>
          <li v-for="(item, key) of menuList" :key="key" :class="{'active': $route.path.indexOf(item.link) !== -1}">
            <i class="iconfont" :class="item.icon"></i>
            <span>{{item.name}}</span>
            <i class="iconfont icon-zhankai"></i>

            <div class="sub-menu">
              <div class="group" v-for="(sub, subKey) of item.sub" :key="subKey">
                <div class="group-name">{{sub.groupName}}</div>
                <ul>
                  <li v-for="(page, pageKey) of sub.pages" :key="pageKey">
            ...
            <div class="account-nav pull-right clearfix">
              ...
              <b-dropdown :menu-right="true">
                ...
                <template slot="dropdown">
                  ...
                  <li>
                    <a role="button" @click="loginOut">退出</a>
                  </li>
                </template>
              </b-dropdown>
            </div>
